...
public class SongTest {
    ...
    private Bundle mockBundle(String prefix) {
        long bundleid = new Random().nextInt(100);
        Bundle r = new Bundle();
    ...
    public void shouldCreateAndUpdateAndDelete() throws Exception {       
        ...
        Song r1 = mockSong("shouldCreateAndUpdate1", b1);
        byte[] r1Json = toJson(r1);
        //CREATE
        System.out.println(new String(r1Json));
        sendPost("http://localhost:8090/rest/v1/song", r1Json, MediaType.APPLICATION_JSON);  
        System.out.println(responseMSG);
        System.out.println(responseCode);             

        Song r2 = mockSong("shouldCreateAndUpdate2", b1);
        byte[] r2Json = toJson(r2);
        //CREATE
        System.out.println(new String(r2Json));
        sendPost("http://localhost:8090/rest/v1/song", r2Json, MediaType.APPLICATION_JSON);  
        System.out.println(responseMSG);
        System.out.println(responseCode);             
    }
